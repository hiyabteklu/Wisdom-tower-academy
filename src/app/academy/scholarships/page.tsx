    ...
    <div className="relative min-h-screen" data-scroll-zoom-skip>
      ...
      <div className="relative max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-16">
        ...
        <header className="mb-10 md:mb-14">
          ...
          {intro && (
            <div className="mt-6 max-w-2xl rounded-2xl border border-rose-400/20 bg-wisdom-card/80 p-5 sm:p-6 shadow-card-3d">
              <FormattedBody text={intro} className="text-white/90" />
            </div>
          )}
