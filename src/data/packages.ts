/**
 * Sellable Academy packages — 500 ETB each (placeholder pricing).
 * Payment is manual (Telebirr / CBE / banks) until automated APIs are approved.
 */
...
export type AcademyPackage = {
  ...
  image: string;
  includes: string[];
  enrolledLabel: string; // placeholder social proof
};
...
export const academyPackages: AcademyPackage[] = [
  {
    id: "grade-9-12",
    name: "Grade 9–12 Package",
    shortName: "G9–12",
    description:
      "Full secondary pathway access — books, practice, and structured paths across grades 9 to 12.",
    priceEtb: PACKAGE_PRICE_ETB,
    href: "/academy/grades",
    image: "https://images.unsplash.com/photo-1509062522246-3755977927d7?w=800&q=80",
    includes: ["All grades 9–12 hubs", "Practice & resources", "Solution-first quiz path"],
    enrolledLabel: "1,240+ students",
  },
  {
    id: "freshman",
    ...
    includes: ["All freshman subjects", "Notes & practice", "Quiz demo access"],
  ...
  },
  {
    ...
    includes: ["UAT track", "Timed practice style", "Strategy notes"],
  ...
  },
  {
    ...
    includes: ["GAT track", "Section drills", "Review path"],
  ...
  },
  {
    ...
    includes: ["COC track", "Competency practice", "Exam readiness"],
  ...
  },
  {
    ...
    includes: ["Exit exam track", "Structured review", "Practice sets"],
...
/** Manual payment channels — replace placeholders with real numbers before launch */
...
export type PaymentMethod = {
  ...
  /** Shown to student */
  instructions: string[];
  /** Account / short code — PLACEHOLDERS until you fill real details */
  accountLabel: string;
  accountValue: string;
  accountName: string;
};
