                ...
                >
                  ...
                  <div className="relative flex flex-col sm:flex-row sm:items-start gap-5">
                    ...
                    <div className="min-w-0 flex-1">
                      <p className={`text-[11px] font-bold uppercase tracking-wider mb-1 ${t.accent}`}>{t.model}</p>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="rounded-2xl bg-wisdom-dark/50 border border-white/8 p-4">
                          <p className="text-xs font-semibold uppercase tracking-wider text-white/80 mb-3">Do this</p>
        ...
        <section className="mb-16 md:mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 stagger-children">
            {subjectMatch.map((s) => (
              ...
              >
                <p className="text-[11px] font-bold uppercase tracking-wider text-amber-300/90 mb-2">{s.kind}</p>
