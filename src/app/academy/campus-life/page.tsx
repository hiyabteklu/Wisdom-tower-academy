                ...
                >
                  ...
                  <div className="flex flex-wrap gap-2">
                    {c.tips.map((t) => (
                      <span
                        key={t}
                        className="text-xs px-2.5 py-1 rounded-lg bg-wisdom-dark/70 border border-white/10 text-wisdom-muted"
                      >
                        {t}
                      </span>
                    ))}
        ...
        <section id="class" className="mb-16 md:mb-20 scroll-mt-24">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {classCards.map((c, i) => (
              <div
                key={c.title}
                className="relative rounded-2xl border border-white/12 bg-wisdom-card/90 p-5 overflow-hidden"
              >
